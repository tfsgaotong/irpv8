...
public class StringUtil {
	...
	/**
	 * 判断字符串是否为空，null;"";" " 都为空，如果为空则返回第二个参数值
	 * 
	 * @param str
	 * 
	 * @return
	 */
	public static String showNull(String sSrc, String sReplace) {
	 ...
	 * @return
	 */
	public static String cutWord(String sSrc) {
		sSrc = sSrc.trim();
		sSrc = sSrc.replaceAll(" ", ",").replaceAll("；", ",").replaceAll(";", ",").replaceAll("，", ",");
		String[] arrTags = sSrc.split(",");
		sSrc = "";
