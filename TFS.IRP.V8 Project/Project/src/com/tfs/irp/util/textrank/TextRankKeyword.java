...
public class TextRankKeyword {
	...
	public String getKeyword(String title, String content){
		return getKeyword(title, content, nKeyword);
	}
	
	public String getKeyword(String title, String content, int maxNum) {
		...
		String result = "";
		for (int i = 0; i<entryList.size()&&i<maxNum ; i++) {
			if(i==0) result = entryList.get(i).getKey();
			else result += separator + entryList.get(i).getKey();
		}
		return result;
	}
