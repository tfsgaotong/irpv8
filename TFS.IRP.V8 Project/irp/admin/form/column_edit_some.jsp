...
<form id="columnFormSome" method="post">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cad9ea">
	...
	<tr>
		...
		<td bgcolor="#FFFFFF" class="main_bright"><input readonly="readonly" name="irpFormColumn.columntablenamecol" validType="editcolumntablenamecol" class="easyui-validatebox" required="true" missingMessage="请填写数据库表字段名" type="text"  value="<s:property value="irpFormColumn.columntablenamecol"/>"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<input type="hidden" name="irpFormColumn.columntype" id="columntype" 
		<s:if test="irpFormColumn.columntype in inttype">value="整型"</s:if>
		 <s:if test="irpFormColumn.columntype in stringtype">value="字符串" </s:if>
		<s:if test="irpFormColumn.columntype in datetype"> value="时间"</s:if>
		<s:if test="irpFormColumn.columntype=='CLOB'">value="大字段"</s:if>
	...
	<tr >
		...
		<td bgcolor="#FFFFFF" class="main_bright">
		<div id="displayvalue"><textarea disabled="disabled" id="textvalue" name="irpFormColumn.displaytypevalue"  class="easyui-validatebox"  ></textarea> </div>
		 <div id="displayvalue2" style="display:none"><textarea disabled="disabled" id="textvalue2"name="irpFormColumn.displaytypevalue"  class="easyui-validatebox" required="true"   missingMessage="请填写字段显示值"   ></textarea><font color="#777">*字段显示值请用“/”隔开</font></div>	
