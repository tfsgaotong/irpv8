(function(b) {
	...
	a.rect = function(p, m) {
		...
		this.toJson = function() {
			var r = "{id:"+E.id+",type:'" + E.type + "',text:{text:'" + f.attr("text")
	...
	a.init = function(x, r) {
		...
		if (r.restore) {
			...
			if(B.props){
				b.extend(true,a.config.props.props,{
					name : {name:'name', label:'名称', value:B.props.props.name.value, editor:function(){return new a.editors.inputEditor();}},
					desc : {name:'desc', label:'描述', value:B.props.props.desc.value, editor:function(){return new a.editors.inputEditor();}}
				});
			}else{
				b.extend(true,a.config.props.props,{
					name : {name:'name', label:'名称', value:'', editor:function(){return new a.editors.inputEditor();}},
					desc : {name:'desc', label:'描述', value:'', editor:function(){return new a.editors.inputEditor();}}
				});
			}
		}
