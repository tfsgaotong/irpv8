...
$(function(){
	...
	$('#holiday').numberspinner({   
	    ...
	    max: 99999999,   
	    editable: true,
	    value:<s:if test="irpUser.holiday==null">0</s:if><s:else>0</s:else>
	});
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cad9ea">
    <input name="irpUser.username" value="${userids}" id="userids" type="text" style="width:80px;display:none"/>
  <tr>
