...
function addEdit(typeid){
 	...
 	$('#addreportconfig').dialog({
 		modal:true,
 		cache:false,
 		href:'<%=rootPath%>admin/set/set_infortype_complaintype_edit.jsp',
 		height:213,
 		width:320,
 		title:'添加意见反馈',
 		resizable:true,
 ...
 */
 ...
 function updateEdit(_configid){
 	...
 	$('#updatereportconfig').dialog({
 		modal:true,
 		href:'<%=rootPath%>menu/updatecomplaintypeInformType.action?informtypeid='+_configid,
 		height:260,
 		width:400,
 		title:'修改意见反馈类型',
 		resizable:true,
...
<table width="100%" border="0" align="center" cellpadding="10" cellspacing="1"  id="table1" bgcolor="#cad9ea">
		...
		<tr>
		 ...
		 <td align="center" bgcolor="#F5FAFE" class="main_bright" width="5%">类型 </td>
