...
function addEdit(typeid){
 	...
 	$('#addreportconfig').dialog({
 		modal:true,
 		cache:false,
 		href:'<%=rootPath%>admin/set/set_report_offenmenuconf_edit.jsp',
 		height:213,
 		width:320,
 		title:'添加常用菜单',
 		resizable:true,
 ...
 */
 ...
 function updateEdit(_configid){
 	...
 	$('#updatereportconfig').dialog({
 		modal:true,
 		href:'<%=rootPath%>set/updateoffenMenuInformType.action?informtypeid='+_configid,
 		height:260,
 		width:400,
 		title:'修改常用菜单',
 		resizable:true,
