...
function page(_nPageNum){
	...
	$('#listrandomuser').panel('refresh',"<%=rootPath%>set/getuserrandom.action?"+queryString);
}
...
function getrandomuser(){
	   ...
	   $('#listrandomuser').panel('refresh','<%=rootPath%>set/getuserrandom.action?countuser='+countuser);
  }
</script>
<form id="pageForm">
...
<s:iterator value="irpUsers" status="userliststatus" >
 <tr>
  <td width="300px" align="left" bgcolor="#F5FAFE" class="main_bright">
  <input name="irpvalueconfigid" value="<s:property value="userid" />" type="hidden" ><!-- <s:property value="(pageNum-1)*pageSize+#userliststatus.count"/> -->
