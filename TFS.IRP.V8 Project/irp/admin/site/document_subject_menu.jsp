...
<script type="text/javascript">
	...
	$(function(){ 
   	...
   	<div id="tab" fit="true" plain="true">
		<div id="lm" style="width: 100%; padding: 5px; overflow: auto;" title="专题"<s:if test="channelorDocument=='channel'">selected="true"</s:if> link="<%=rootPath %>site/allsubjectlist.action?siteid=<s:property value="siteid"/>&channelorDocument=channel&id=<s:property value="id"/>&isGCChannel=1"></div>
