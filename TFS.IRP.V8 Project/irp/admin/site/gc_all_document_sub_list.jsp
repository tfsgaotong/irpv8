...
<html>
  ...
  <script type="text/javascript"> 
  	...
  	function fanhuiallchannel(_siteid,_parentid){
  	  $('#lm').panel('refresh','<%=rootPath %>site/allsubjectlist.action?siteid='+_siteid+'&channelorDocument=channel&id='+_parentid+'&isGCChannel=1');
  	  ...
  	  if(panel){
  	   ...
  	   panel.attr('link','<%=rootPath %>site/allsubjectlist.action?siteid='+_siteid+'&channelorDocument=channel&id='+_parentid+'&isGCChannel=1');
  	  } 
   } 
  //恢复专题回收站里面的栏目
	...
	function page(_nPageNum){
		...
		var queryString = $('#channelpageForm').serialize(); 
	 	...
	 	if(isGCChannel!=0){
	 		...
	 		$('#lm').panel('refresh',"<%=rootPath %>site/gc_alldocumentsublist.action?"+queryString);
	 	} 
	} 
 	           ...
 	           <td colspan="5" nowrap="nowrap" bgcolor="#cad9ea">
	 	           ...
	 	           <tr>
	 	           	<td width="50%" style="padding-left: 5px;">  
		 	            ...
		 	            <a href="javascript:void(0)" onclick="fanhuiallchannel(<s:property value='siteid'/>,<s:property value='id'/>)">回到专题列表</a> 
