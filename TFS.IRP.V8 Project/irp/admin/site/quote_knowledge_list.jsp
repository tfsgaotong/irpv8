 ...
 */
	...
	*/
	function page(_nPageNum){
		...
		$('#selecQuestionQuotecontent').panel('refresh',"<%=rootPath %>site/siteshowchanneldoc_document.action?"+queryString);
	}
	/**
	*排序
	*/
...
<table width="100%" border="0" align="center" cellpadding="10"
		...
		<tr>
		 <td align="center" bgcolor="#F5FAFE" class="main_bright" width="10%"><input id="selecdocid<s:property value='docid' />" name="chnlDocLinkscatach" onclick="moveSelectAlready(<s:property value='docid' />)" type="checkbox" value="<s:property value='docid' />">&nbsp;<s:property value="(pageNum-1)*pageSize+#chnlDocLinksstatus.count"/></td>
		 <td align="left" bgcolor="#F5FAFE" class="main_bright" style="padding-left: 10px"  ><a href="javascript:void(0)" onclick="showdocumentinfo(<s:property value='docid'/>)" title="<s:property value='doctitle'/>"><s:property value='doctitle'/></a></td>
		 <td align="center" bgcolor="#F5FAFE" class="main_bright"><a href="javascript:void(0);" onclick="showDoc(<s:property value='channelid'/>)">[<s:property value="findChnlName(channelid)"/>]</a></td>
		 <td align="center" bgcolor="#F5FAFE" class="main_bright"  ><a href="<%=rootPath%>site/client_to_index_person.action?personid=<s:property value='cruserid'/>" target="_blank" ><s:property value="cruser"/></a></td>
		</tr>
		</s:iterator>
		<tr bgcolor="#FFFFFF">
