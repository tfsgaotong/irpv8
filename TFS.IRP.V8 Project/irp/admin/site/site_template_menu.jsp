...
<script type="text/javascript">
	$(function(){ 
   	...
   	<div id="tab" fit="true" plain="true">
		<div id="lmtemplate" style="width: 100%; padding: 5px; overflow: auto;" title="词条模版" selected="true" link="<%=rootPath %>set/templateknowlist.action?cateid=<s:property value="cateid" />&pageNum=1&orderField&searchWord&searchType"></div>
