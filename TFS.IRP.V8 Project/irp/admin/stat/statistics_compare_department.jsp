      ...
      var date_end_time=$('#end_time').datebox('getValue'); 		  
  	 ...
  	 if(start_end=="logs_appoint_date"){
  	   ...
  	   if (date_start_time>date_end_time) {
  		...
  		jump("<%=rootPath %>leave/compareLeaves.action?type=1&orderField&c_start_end="+start_end+"&starttime="+date_start_time+"&endtime="+date_end_time+"&groupIds="+ss);	
