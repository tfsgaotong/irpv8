...
$(function (){
	...
	var userIds_1 = $('#userIds').val().split(",");
	jump('<%=rootPath %>user/import_user_list.action?groupId=1&userIds='+userIds_1);
...
<div id="importList" class="easyui-layout" style="width:800px;height:441px;">
    ...
    <input type="hidden" name="userNames" id="userNames" value="<s:property value='userNames'/>"/> 
	<input type="hidden" name="userIds" id="userIds" value="<s:property value='userIds'/>"/> 
</div>
</body>
</html>
