	...
	<div style="margin-left: 20px;">
		  ...
		  <div style="float: left;width: 650px;text-align: right;">
		        <label style="margin-left:200px;">
						<a href="javascript:void(0)" class="linkb14" onclick="infromDocument(<s:property value='#map["DOCID"]'/>)">通过</a>&nbsp;
						<a href="javascript:void(0)" class="linkb14" onclick="informdeletedocument(<s:property value='#map["DOCID"]'/>,<s:property value='#map["INFORMID"]'/>)">取消</a>
		        </label> 
		  </div>
	</div>
	 <div>
		<dl id="<s:property value='#map["DOCID"]'/>div"
			...
			<dd>
				<a target="_blank" href="<%=rootPath%>site/client_to_index_person.action?personid=<s:property value='#map["CRUSERID"]'/>" class="linkb14">
			...
			<dd style="padding-bottom: 5px;">
				<span style="margin-left: 10px;"> <s:date name="CRTIME" format="yyyy-MM-dd HH:mm" />  </span>
			</dd>
		</dl>
	</div>	
	</div>
