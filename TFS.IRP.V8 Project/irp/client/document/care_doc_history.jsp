 ...
 * 历史版本恢复
 */
function replayVHistory(_docid,_docvid){
...
<div class="zj_wBox">
	<h1 class="zj_pageMark">
		<div style="  width: 900px; overflow: hidden; text-overflow:ellipsis; white-space: nowrap; padding-left: 10px;">
			...
			&nbsp;&gt;&nbsp;
			<s:property value="irpDocument.doctitle"/> &nbsp;&gt;&nbsp;<s:property value="irpDocument.docversion" />.0版
			<label style="margin-left: 50px;" >
			<a  href="javascript:void(0);" style="color: #005757;" onclick="replayVHistory(<s:property value="irpDocument.knowledgeid"/>,<s:property value="irpDocument.docid"/>)" >版本恢复</a>
			</label>
							...
							<table width="1000" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="519" valign="top" class="gray12"
										style="padding-top:10px;"><strong>创建者</strong>： <a
										target="_blank"
										href="<%=rootPath%>site/client_to_index_person.action?personid=<s:property value='irpDocument.cruserid'/>"><s:property
												value="irpDocument.cruser" /></a> <%--如果创建者等于登陆者，就不可以发送私信 --%> <s:if
											test="loginUserId != irpDocument.cruserid">
											<a href="javascript:void(0);"
												onclick="messageContentView('<s:property value="irpDocument.cruser"/>',<s:property value="irpDocument.cruserid"/>,<s:property value='irpDocument.docid'/>)"><img
