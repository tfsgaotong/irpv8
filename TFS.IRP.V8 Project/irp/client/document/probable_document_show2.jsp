...
<div class="zj_title1">
            	...
            	<img src="<%=rootPath %>client/images/addbuddy.gif"/>
            	 ...
            	 </h1><label style="float: right;margin: 0 10px 0 0;cursor: pointer;" onclick="switchOverViewSel()" >切换视图</label> </div>
            	 <div class="zj_leibie"></div>
</div>
        <div class="zj_boxk">
         <s:if test="chnlDocLinks!=null &&chnlDocLinks.size()>0">
                <table cellpadding="0" cellspacing="0" border="0" background="<%=rootPath %>client/images/gl_r3_c2.jpg" width="671" class="boxcenter listTitle">
                	<tr>
...
<form id="pageForm">   
		...
		<s:hidden name="viewchecktwo" id="viewcheckone" value="viewchecktwo"></s:hidden>
	</form>