...
<table width="100%" border="0" align="center" cellpadding="10"
		...
		<tr>
		 <td align="center" bgcolor="#F5FAFE" class="main_bright" style="text-align: left;"><input id="selecdocid<s:property value='docid' />" name="chnlDocLinkscatach" onclick="moveSelectAlready(<s:property value='docid' />)" type="radio" value="<s:property value='docid' />">&nbsp;<s:property value="(pageNum-1)*pageSize+#chnlDocLinksstatus.count"/></td>
