					...
					<s:if test="listExpert.size()>0">
						<s:iterator value="listExpert">
							<div class="swiper-slide ss-one"
								...
								<div class="e-card">
									<div class="e-img">
										<a class="from_expert" href="<s:url namespace="/site" action="client_to_index_person"><s:param name="personid" value="userid" /></s:url>" target="_blank" title="<s:property value="username" />">
