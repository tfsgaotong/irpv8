...
function selectuserbysm(){
	...
	var result= $.ajax({
		type:'post',
		url:"<%=rootPath%>medal/listmedalclient.action",
		dataType: "json",
		async: false,
   		cache: false
	}).responseText;
...
function page(_pagenum){
	...
	var result=$.ajax({
		type:'post',
		url:"<%=rootPath%>medal/listmedalclient.action?pageSize=8&"+queryString,
		dataType: "json",
		async: false,
   		cache: false
	}).responseText;
...
<div class="main" style="background: transparent none repeat scroll 0px 0px;">
	<!--左侧内容-->
		...
		<!-- <a id="sendCommentid" style="color:rgb(242, 130, 30);" class="over"  id="receivemessage"  href="javascript:void(0)" onclick="selectuserbysm('')"><font id="aa" class="linkbh14" >所有商品</font></a>&nbsp;&nbsp;
		<a id="receiveCommentid"  href="javascript:void(0)" onclick="selectuserbysm(20)"><font id="bb" class="linkbh14">积分兑换商品</font></a>&nbsp;&nbsp;
		<a id="activeCommentid"  href="javascript:void(0)" onclick="selectuserbysm(10)"><fontv id="cc" class="linkbh14">活动商品</font></a>
		<a id="icanCovertGoods"  href="javascript:void(0)" onclick="selectuserbysm(1)"><fontv id="cc" class="linkbh14">我能兑换的商品</font></a> -->
	</h1>
	...
	<!-- <div id="footerchatwindw" style="position: fixed;bottom: 1px;right: 1px;width:230px ;height:40px;cursor: pointer;background-color:#6C6C6C;line-height: 40px;color: #FFFFF4;text-align: center;" title=""  >
