...
<div id="informdiv<s:property value='INFORMID'/>">
	<div style="margin-left: 20px;">
		  ...
		  <div style="float: left;width: 650px;text-align: right;">
		        <label style="margin-left:200px;">
		             <a href="javascript:void(0)" class="linkb14" onclick="informpass(<s:property value='MICROBLOGID'/>)">通过</a>&nbsp;
		             <a href="javascript:void(0)" class="linkb14" onclick="informdelete(<s:property value='MICROBLOGID'/>,<s:property value='INFORMID'/>)">取消</a>
		        </label> 
		  </div>
	</div>
 <div>
