...
function addBug(){ 
	...
	$.ajax({
		url: '<%=rootPath%>bug/addBug.action?'+postStr,
		type: 'post',
	    async: true,
	    cache: false,
	    data:{
	    ...
	    success:function (){
	    	$.dialog.tips('新建Bug成功',1,'32X32/succ.png',function(){ 
	    		//alert(projectId);
				 window.location.href='<%=rootPath%>bug/tobugmanage.action?projectId='+projectId;
				});						
	    },
	});
	}
					...
					if(callback!=""){ 
						$.dialog.tips('新建Bug成功',1,'32X32/succ.png',function(){ 
						 //window.location.href=document.referrer;
							...
							$.dialog.tips('新建Bug失败',0.5,'32X32/fail.png');	
						}
				},
				error:function(){
					$.dialog.tips('新建Bug失败',0.5,'32X32/fail.png');
...
<form id="addBugPage"  method="post" onsubmit="return false;">
	 	...
	 	<div style="width: 100%;float: left;"  class="newForm"> 
	 		<div style="width: 50%;float: left;"><label style="color: #171717;font-size: 18px;line-height: 40px;font-weight: normal;" >提交BUG（<font style="color: red;">*</font>必须填写项）</label></div>
	 		 
		 	<div class="proiterm"  style="float: left;width: 50%;text-align: right;">  
		  	<span class="txt_lptaskt">项目：</span>
		  	<!-- 
	 	...
	 	<div  class="newForm" style="width: 100%;float: none;margin-top: 30px;"> 
			<div> 
				...
				&nbsp;&nbsp;<input name="bugTitle1" class="artTitle easyui-validatebox" required="true" validtype="length[2,300]" placeholder="添加Bug标题"  id="bugTitle"   />  
			</div> 
        ...
        <div class="newForm"  style="width: 100%;float: none;margin-top: 20px;"> 
        	...
        	&nbsp;&nbsp; 
				<input id="offPersonName" class="easyui-validatebox" readonly="readonly" onclick="checkTaskOffpersonId()"   required="true"  type="text"/> 
		...
		<!-- </form> -->
 		...
 		<div style="clear: both;"></div>
	  	<div class="newForm"  style="width: 100%;margin-top: 20px;"> 
	  		<div class="txt_lptaskt"  style="width: 14%;float: left;line-height: 30px;text-align: right;">是否发送私信：</div>
	  		&nbsp;&nbsp;
 		...
 		<div>
 		   	...
 		   	<div class="abc" style="float:left;">
		    	<a onclick="window.close()"  class="btn1 " title="取消" href="javascript:void(0);">关&nbsp;&nbsp;&nbsp;&nbsp;闭</a>
		    </div>
 		</div>   	
