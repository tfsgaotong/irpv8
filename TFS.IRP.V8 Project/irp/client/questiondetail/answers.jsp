					...
					<div>
						<div>
							<div>
								<!-- 问题主体开始 -->
								<div class="itemfeed"
									style="width:676px; overflow:hidden; border:none; padding-left:5px;">

									<div class="left_ifed">
										<a hidefocus="true" title="" href="javascript:void(0)">
											<img src="<s:property value="irpUser.defaultUserPic" />" width="50" height="50" />
										</a>
									</div>
									<div class="right_ifed">
										...
										<div class="main_fed">
											...
											<div class="master_mfed" style="position:relative">
												...
												<div
													style="position:absolute; right:0; top:0; bottom:0; line-height:36px;">
													<div class="btn_amfed">
													<ul>
										...
										<div id="answer" class="" style="display:none;">
											...
											<div id="hideknowselected" style="display: none;"> 
