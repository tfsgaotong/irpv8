...
function initZTree(){
	$.fn.zTree.init($("#categoryTree"), {
		...
		async: {
			enable: true,
			url:"<%=rootPath%>category/getAllCategory.action?showExpertList=2" 
		},
		callback: {
...
function sepage(_nPageNum){
	...
	$.ajax({
		type:'post',
		url:'<%=rootPath%>expert/select_expert_list.action',
		data:{
			pageNum: _nPageNum,
			pageSize: pageSize,
...
<div id="expertDiv">
	...
	<div class="main-gr" style="width: auto;margin-top:0px;">
		<div class="left" style="width: 160px;">
			<ul id="categoryTree" class="ztree" style="width:150px;"></ul>
		</div>
		<!--右侧内容-->
		<div id="selExpertList" class="right" style="width:470px;">
			加载专家信息...
		</div>
	</div>
</div>