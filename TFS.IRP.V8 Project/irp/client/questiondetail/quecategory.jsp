...
//		    cancel: true,
	 ...
	 <!-- 左侧区域 -->
		...
		<div style="width: 245px;float: left;display: inline;">
			...
			<s:iterator value="list">
	        	<div class="folder">
	            	<p><a href="<s:url namespace="/question" action="toquecategory"><s:param name="categoryId" value="categoryid" /></s:url>">
				<s:property value="cdesc" /></a></p>
	                ...
	                <s:if test="#childCate!=null && #childCate.size()>0">
	                	...
	                	<s:iterator value="#childCate">
	                    	<li><a href="<s:url namespace="/question" action="toquecategory"><s:param name="categoryId" value="categoryid" /></s:url>">
    ...
    <section class="layoutMiddle1" style=";width:955px;margin:0">
        <div style="float: left;width: 945px;margin-left:10px;">
    <!--    <div class="shuru" id="Num"></div> -->
				<h1 class="zl3" id="allQuestions" 
					...
					<a id="all" href="javascript:void(0)"
						_href="<%=rootPath%>question/questionList.action" class="over" _data="id=<s:property value="categoryId" />"
						onclick="tabsSelected(this)"><font class="linkbh14">全部</font></a>
				   <a id="no"
						 href="javascript:void(0)"
						_href="<%=rootPath%>question/questionListOfNoResoule.action" _data="id=<s:property value="categoryId" />"
						onclick="tabsSelected(this)"> <font class="linkbh14">待解决</font>
					</a>
					 <a id="yes" href="javascript:void(0)"
						_href="<%=rootPath%>question/questionListOfResoule.action" _data="id=<s:property value="categoryId" />"
						onclick="tabsSelected(this)"> <font class="linkbh14">已解决</font>
					</a>
					 <a id="minequestion" href="javascript:void(0)"
						_href="<%=rootPath%>question/questionListofminequestion.action" _data="id=<s:property value="categoryId" />"
						onclick="tabsSelected(this)"> <font class="linkbh14">我的提问</font>
					</a>
					 <a id="mineanswer" href="javascript:void(0)"
						_href="<%=rootPath%>question/questionListofmineanswer.action" _data="id=<s:property value="categoryId" />"
					...
					<a id="minenoanswer" href="javascript:void(0)"
						_href="<%=rootPath%>expert/questionToExpert.action" _data="id=<s:property value="categoryId" />"
						onclick="tabsSelected(this)"> <font class="linkbh14">待解答</font>
					</a>
					</s:if>					
				</h1>
				<div  id="questionsAll" class="fyh" style="width:945px;overflow: hidden;margin:0">
					<!-- 问题主题开始 -->
					<!-- 问题主题结束-->
				</div>
        </div>
        <!-- 
        <div class="wd_right" style="width:258px;float: right;">
            <div class="title1"><h4><a href="javascript:void(0)">热点提问</a></h4></div>
