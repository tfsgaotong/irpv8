...
function loginSubmit(){
	if(usernamevalid()&&passvalid()&&alphabetvalid()){
		$('#loginForm').submit();
	}
}
</script>
...
<div class="w1200">
    <div class="bd" style="height: 454px;">
        ...
        <span id="yanzhengma" style="position: absolute;left: 46px;top:294px;font-size: 12px;color: #f00"></span>
    </div>
	...
	$(function (){
		...
		$('#loginForm').form({
			...
			success:function(data){
					...
					$.messager.alert('<s:text name="错误提示" />','<s:text name="验证码输入有误！请重新输入" />');
					 $('#kaptchaImage').click();
				}else{
