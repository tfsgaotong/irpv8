...
<s:iterator value="userlist">
	...
	<div style="padding: 5px 5px 5px 5px;border-bottom: thin dotted #d0d0d0;cursor: pointer;width: 100%;float: left;" id="dialoguechat<s:property value="userid" />" >
		...
		<div style="float: left;width: 75%;">
			...
			<s:if test="userid!=2">
			<div onclick="okForcus(<s:property value="userid" />)" id="guanzhusys<s:property value="userid" />" style="width: 20%;float: left;background-repeat: no-repeat;background-position: center;background-image: url('<%=rootPath%>client/images/icons/cancel.png');" title="移除用户">
			&nbsp;
			</div>
			</s:if>
		</div>
