...
function userscore(){
	var str=$.ajax({
		type:'post',
		url:'<%=rootPath%>site/finduserscore.action',
		data:{'docid':m_docid},
		dataType: "json",
		async: false,
	    cache: false 
	...
	<section class="details">
        ...
        <section class="text">
				...
				<div class="annex">
					...
					<s:iterator value="attacheds">
						<tr>
							...
							<span style="display: block;background-image: url(<%=rootPath %>file/readfile.action?fileName=<s:property value='@com.tfs.irp.util.ThumbnailPic@searchFileName(attfile,"_150X150")'/>); background-position: -11px -10px; width:40px; height:43px; "></span>
							</s:if>
            ...
            <%-- 	<s:if test="irpDocument.irpMostTreadDing==null && irpDocument.irpMostTreadCai==null">
            	...
            	<s:if test="isCrUser=='true'">
            	<a href="javascript:void(0)" onclick="documentLogs()"><span>阅读</span><label>阅读</label></a>
            	</s:if>
            	<script type="text/javascript">
...
<div style="width:100%;background: #fff;position:fixed; bottom: 0;padding-top:4px;z-index: 2147483647;border-top: 1px solid #b1aeae;">
			<div class="details" style="width: 680px;">
				<div class="text">
					<div class="sociality" >
 ...
 <div id="userscore" style="padding-top: 8px;"></div>
</div>
</body>
</html>