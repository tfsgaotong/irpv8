...
<head>
<meta charset="utf-8">
<title>精华知识-<s:property value="irpChannel.chnldesc" /></title>
...
<body>
<form id="pageForm" action="<s:url namespace="/document" action="document_essence_list"><s:param name="channelid" value="channelid" /></s:url>" method="post">
...
<section class="mainBox">
	...
	<section class="result">
    	<div class="title">
    		精华知识
    		<em onclick="window.location.href='<s:url namespace="/document" action="document_list"><s:param name="channelid" value="channelid" /></s:url>'">返回</em>
   		</div>
    	<section class="mavin">
        	<dl>
