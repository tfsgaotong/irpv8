...
<section class="mainBox">
	...
	<s:iterator value="rootChannels" status="index">
		...
		<strong><a href="<s:url namespace="/document" action="document_subject_list"><s:param name="channelid" value="channelid" /></s:url>" title="<s:property value="chnldesc" />"><s:property value="chnldesc" /></a></strong>
		</s:if>
		<s:else>
		 > <a href="<s:url namespace="/document" action="document_subject_list"><s:param name="channelid" value="channelid" /></s:url>" title="<s:property value="chnldesc" />"><s:property value="chnldesc" /></a>
		</s:else>
	</s:iterator>
	</article>
