...
<html>
  <head>  
	<title>快捷文章发表框</title>
<link rel="StyleSheet" href="<%=rootPath %>admin/editor/neweditor/editor/base.css">
<script type="text/javascript" src="<%=rootPath %>admin/editor/neweditor/editor/editor.js"></script>
