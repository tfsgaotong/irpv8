	...
	<div class="bg01">
		...
		<div style="" class="leftmenu" style="">
			<nav class="allBtns">
                <ul>
                	<li>
                		<a style="cursor:pointer;" href="<%=rootPath%>exam/exammenus.action">待参加的考试</a>
                	</li>
                	<li>
                		<a style="cursor:pointer;" href="<%=rootPath%>exam/nowexaming.action">正在进行的考试</a>
                	</li>
                	<li>
                		<a style="cursor:pointer;" href="<%=rootPath%>exam/alreadyexammenu.action">参加过的考试</a>
                	</li>
                </ul>
            </nav>
        <!-- 
		<div class="title" style="margin-top: 10px;">
			<h1><a style="border-bottom: solid 2px #186fd2;padding-bottom:6px;">参加过的考试</a></h1>
		</div>
			<ul>
