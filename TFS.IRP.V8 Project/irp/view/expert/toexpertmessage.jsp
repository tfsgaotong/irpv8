...
<body>
 ...
 <form method="post" id="messageContentForm" class="uiConnForm">
        ...
        <p><font style="float: left;">内&nbsp;&nbsp;&nbsp;容:</font>
          <span id="microMessageFont_01"  style="float: left;margin-left: 210px;">还可以输入<label id="microMessageFontCount_01" style="font-family:Tahoma,Arial,sans-serif; font-size: 18px;"><s:property value="messagecount" /></label>个字</span>
		  <span id="microMessageFont_02"  style="float: left;margin-left: 210px; display: none;">已超出<label id="microMessageFontCount_02" style="font-family:Tahoma,Arial,sans-serif; font-size: 18px;color:red;"></label>个字</span>
        </p>
