...
<section class="mainBox">
	<section class="details">
        ...
        <section class="text">
        	<article class="straight"  style="min-height: 400px;">
	       		<div id="printConn">
	            	<h1><s:property value="irpGoods.goodsname" /></h1>
	                <table class="textInfo">
	                	<tr>
	                		<td>发布时间：<s:date name="irpGoods.crtime" format="yyyy-MM-dd HH:mm" /></td>
	                		<td width="10"></td>
	                		<td>库存：<s:property value="irpGoods.stocknum" /></a></td>
	                		<td width="10"></td>
	                		...
	                		<td width="10"></td>
	                		<td>所需积分：<s:property value="irpGoods.needscore" /></td>
	                		<td width="10"></td>
	                		<s:if test="irpGoods.salestate==20">
	                		<td>
    ...
    <%--<div class="area20"></div> --%>
       ...
       <%-- <div class="area20"></div>
        ...
        <div class="wd_right" style="width:250px;float: right;">
	        	<div class="title1"><h4 style=""><a href="javascript:void(0)">热销商品</a></h4></div>
	            <section id="hotGoodsList" class="listpan1">
       			</section>
        </div>
...
function eliteDoc(){
	var str=$.ajax({
		type:'post',
		url:'<%=rootPath%>goods/hotgoodslist.action',
		dataType: "json",
		data:{'id':<s:property value="irpGoods.goodsid" />},
		async: false,
		cache: false
	}).responseText;
