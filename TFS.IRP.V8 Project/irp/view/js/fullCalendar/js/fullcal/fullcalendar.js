...
function BasicView(element, calendar, viewName) {
	...
	function renderBasic(r, c, showNumbers) {
		...
		if (!tbody) { // first time, build all cells from scratch
			...
			ssd=d.getFullYear()+"-"+d.getMonth()+"-"+d.getDate();
			for (i=0; i<rowCnt; i++) {
				...
				for (j=0; j<colCnt; j++) {
					s += "<td class='fc-" +
						...
						' fc-not-today') + "'>" +
						(showNumbers ? "<div class='fc-day-number' ><a href='#' data='"+d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate()+"'>" + d.getDate() + "</a></div>" : '') +
			...
			tbody.find('td').each(function() {
				...
				td.find('div.fc-day-number').html("<a href='#' data='"+d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate()+"'>" + d.getDate() + "</a>");
