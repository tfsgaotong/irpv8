...
%>  
 ...
 <div id="knowmslenu">
	<div id="knowslprepend">
	<s:if test="irpChannels.size()>0">
			<div class="pan">
				<ul class="myDiscuss list5">
					 <s:iterator value="irpChannels" var="map">
						<li id="subjectsl<s:property value="#map.channelid" />"><s:date name="#map.crtime" format="yyyy-MM-dd HH:mm" />
							<div class="userIcon">
								<dl>
							...
							<div>
								<a href="javascript:void(0)" onclick="updatechannelbychannelid('knowsl',<s:property value='#map.parentid' />,<s:property value='#map.channelid'/>)" ><s:property value="#map.chnlname" /></a><a href="#"></a>
								<p>
									<a target="_blank" href="<%=rootPath%>site/client_to_index_person.action?personid=<s:property value='#map.cruserid' /> " class="linkb14">发起人 : <s:property value="#map.cruser" /></a> <a href="javascript:void(0)" onclick="deleteSubject('subjectsl',<s:property value='#map.parentid' />,<s:property value='#map.channelid'/>)" > 删除</a> | <a href="javascript:void(0)" onclick="updatechannelbychannelid('knowsl',<s:property value='#map.parentid' />,<s:property value='#map.channelid'/>)" >修改</a> 
								</p>
							</div>
							</section>
							<div class="clear"></div>
