...
<section class="setUp">
	<div class="tabTitlenoline">
		<div class="current" _href="<s:url namespace="/leave" action="managerLeaveList" ><s:param name="type" value="type"/>
		<s:param name="status" value="20"/></s:url>">
			<a href="javascript:void(0)" onclick="switchFlow(this)">待办</a>
			<p class="labBg"></p>
		</div>
 		<div _href="<s:url namespace="/leave" action="managerLeaveList" ><s:param name="type" value="type"/>
