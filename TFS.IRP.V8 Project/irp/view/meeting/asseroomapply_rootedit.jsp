        ...
        <div id="reservebox" title="会议室预约">
           ...
           <form id="submit"> 
            ...
            <div class="rowElem" style="margin-left: 20px;margin-top: 10px; padding-bottom: 15px;">
            	...
            	&nbsp;<a style="border:thin solid #D3D3D3;border-radius:9px;padding:6px;background-color:rgb(245, 245, 245);" href="javascript:void(0)" class="linkbh14" onclick="addUser(2)">选择用户</a>
            </div>
            <div class="rowElem" style="margin-left: 20px;margin-top: 10px;">
                <label>参会人数：</label>
