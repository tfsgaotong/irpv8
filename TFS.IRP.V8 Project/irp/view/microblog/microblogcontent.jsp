                    ...
                    <dd class="text" onmouseover="giveImagesValues(<s:property value='MICROBLOGID' />)">
						...
						<div   id="commentDiv<s:property value='MICROBLOGID' />" style="display: none;text-align: center;margin-top: 10px; ">
						    ...
						    <div class="publishercss" atype="cn" id="cnpub<s:property value='MICROBLOGID' />">
						    	 <textarea      style="border: thin solid #bdbdbd;border-radius:5px;width: 650px;font-size: 14px;"  name="commentInfo<s:property value='MICROBLOGID' />"  id="commentInfo<s:property value='MICROBLOGID' />" onkeyup="microblogCommentFontInfo(<s:property value='MICROBLOGID' />)" ></textarea>
						    </div>
							...
							<p style="text-align: right;margin-right: 15px;">
								...
								<span>
									...
									<input onclick="commentReply(<s:property value='MICROBLOGID' />,<s:property value='USERID' />)" style="background: none repeat scroll 0% 0% #5F9DDD;border: medium none;border-radius: 3px;text-align: center;color: #FFF;line-height: 26px;width: 50;margin-top: 4px;" type="submit"  value="回复" >
