...
%>
<s:iterator value="irpMicrobloglist" status="lists">
            	...
            	<dl>				
                    ...
                    <dd class="text">					
                        ...
                        <p><s:property value='getMicroblogContent(microblogcontent)' escapeHtml="false" /></p>
	                        ...
	                        <article class="quote">
	                            <p>
	                            	<a target="_blank" style="float: left;" class="linkb14"  href="<%=rootPath%>site/client_to_index_person.action?personid=<s:property value='#microobj.userid' /> ">
	                            	<s:property value="getShowPageViewNameByUserId(#microobj.userid)" />&nbsp;:&nbsp;</a>
	                            	<s:if test="#microobj.userid==2"><img style="float: left;margin-top: 5px;" alt="微知助手" src="<%=rootPath %>view/images/micropicicons/mobile-attach-4.png"></s:if>
	                            	<s:property value="getMicroblogContent(#microobj.microblogcontent)" escapeHtml="false" />
								</p>
