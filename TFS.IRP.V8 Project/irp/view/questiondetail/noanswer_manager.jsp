...
<section class="setUp">
	<div class="tabTitlenoline">
		<div id="covert" class="current" _href="<s:url namespace="/question" action="questionListOfNoResoule" />">
			<a href="javascript:void(0)" onclick="switchFlow(this)">待解决的问题</a>
			<p class="labBg"></p>
		</div>
		<div id="myanswer" _href="<s:url namespace="/expert" action="questionToExpert" />">
			<a href="javascript:void(0)" onclick="switchFlow(this)">待解答的问题</a>
			<p class="labBg"></p>
		</div>
	</div>
