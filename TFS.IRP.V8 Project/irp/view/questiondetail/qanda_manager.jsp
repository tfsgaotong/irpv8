...
<section class="setUp">
	<div class="tabTitlenoline">
		<div id="covert" class="current" _href="<s:url namespace="/question" action="questionListofminequestion" />">
			<a href="javascript:void(0)" onclick="switchFlow(this)">我提出的问题</a>
			<p class="labBg"></p>
		</div>
		<div id="myanswer" _href="<s:url namespace="/question" action="questionListofmineanswer" />">
			<a href="javascript:void(0)" onclick="switchFlow(this)">我回答的问题</a>
			<p class="labBg"></p>
		</div>
	</div>
