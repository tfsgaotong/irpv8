...
<section class="setUp" style="width:100%;clear:both;">
	<div class="pan" style="width:100%;padding-left:5px">
		<form id="tagTypeFrom" method="post" onsubmit="return false;">
            <table>
                <tr>
                    <td class="inputText">
                    	<input id="typenameTxt" name="irpTagType.typename" value="" style="height:24px;width:200px;" class="easyui-validatebox" required="true" validType="isExist[2,30,0]" missingMessage="请填写标签类型名称" />
                   	</td>
                   	<td width="3"></td>
                   	<td width="20">
                    	<font color="red">*</font>
