            ...
            <div>
                <div style="font-size: 24px;line-height: 34px;border-bottom: 1px solid #BDBDBD;padding: 0 0 10px 0;">
                    ...
                    <%-- <s:if test="irptermofword.termisdel==@com.tfs.irp.term.entity.IrpTerm@TERMISDELNORMAL">
                        <a href="javascript:void(0)" style="border: 1px solid #DBDBDB;padding: 2px 8px;font-size: 14px;margin: 0 0 0 10px; text-decoration: none;" onclick="termEdit(<s:property value="irptermofword.termid" />)">编辑</a>   
                    </s:if> --%>
                    <%-- <s:if test="irptermofword.termisdel==@com.tfs.irp.term.entity.IrpTerm@TERMISDELNORMAL">
