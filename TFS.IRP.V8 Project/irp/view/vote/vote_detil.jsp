				...
				<div class="touPiao">
					<div class="group_list">
						...
						<span>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;
							<s:if test="irptitle.count==null">0</s:if>
							<s:else>
								<s:property value="irptitle.count" />
							</s:else>
							人 参与
						</span>
					...
					<s:iterator value="maplist" status="mapliststatus">
						...
						<div>
							<span>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;
								<s:if test="#votekey.checktype==1"></s:if>
					...
					<s:if test="irptitle.ispublish==2">
						<div class="touPiao_btn">
							<input onclick="subvote()" style="background-color: lightblue;" class="btn_touPiao" name="" type="button" value="投票" />
							<span>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="javascript:void(0)" onclick="showresult()">查看结果>></a>
							</span>
						</div>
					</s:if>
					<s:else>
