...
function addoption(){
	...
	$("#optionul").append("<li style=\"height:30px; margin-left: 10px;display: inline-block;margin-top:2px;\"><span>"+(index+1)+"</span>&nbsp;<input name=\"option\" type=\"text\" class=\"optoninpt\" required/>&nbsp;&nbsp;URL:&nbsp;&nbsp;&nbsp;<input name=\"urltext\" type=\"text\" class=\"optoninpt\"/></li>");
...
function addlastoption(){
	//获取li
	var index=$("#optionul li").length;
	$("#optionul").append("<li style=\"height:30px; margin-left: 10px;display: inline-block;margin-top:2px;\"><span>"+(index+1)+"</span>&nbsp;<input value=\"说不清\" name=\"option\" type=\"text\" class=\"optoninpt\" required/>&nbsp;&nbsp;URL:&nbsp;&nbsp;&nbsp;<input name=\"urltext\" type=\"text\" class=\"optoninpt\"/></li>");
	$("#optionul li a").remove();
        ...
        <li id="opteionvote">
            <div>
                ...
                <ul id="optionul">
                    <li style="height:30px; margin-left: 10px;display: inline-block;margin-top:-3px;">
                        <span>1</span>
                        <input name="option" type="text" class="optoninpt" required/>&nbsp;&nbsp;URL:&nbsp;&nbsp;
                        <input name="urltext" type="text" class="optoninpt"/>
                    </li>
            ...
            <div>
                <ul style="margin-top: 0;">
	               <li id="addoptionli" style="height:30px;line-height:30px; margin-left: 10px;display: inline-block;margin-top:0;">
                        <a href="javascript:void(0)" onclick="addoption()">再加一项</a>&nbsp;&nbsp;
                        <a href="javascript:void(0)" onclick="addlastoption()">添加说不清</a>
                        <span style="margin-left:40px;color:gray;">至少设置两项，每项最多200个字 </span>
                    </li>
                </ul>
            </div>
        </li>
