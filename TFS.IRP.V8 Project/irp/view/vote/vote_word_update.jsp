		 ...
		 $.ajax({
				...
				async: false,
		   		...
		   		success:function(data){
		   		    ...
		   		    window.opener.document.getElementById("vote_launch").click();
		   		}
			});
	}
 }
						...
						<form id="votetitleform<s:property value='#votekey.voteid'/>">
							<span>
								...
								<span id="lesscheck" style="display:none;">
									至少选
									<input style="width: 30px;" value='<s:property value="#votekey.lesscheck"/>' type="text" name="irpvotetitle.lesscheck" />
									个
								</span>
								&nbsp;
							...
							<s:iterator value="value" status="status">
								...
								<s:iterator value="value[#status.index]">
									...
									<div id="rock" class="bt" style="width: 900px;height:30px; ">
										...
										选项
										<input style="width: 300px;height: 30px;" type="text" id="<s:property value='optionid'/>" name="voteoption" value=" <s:property value='voteoption'/>" />
										URL
										<input style="width: 258px;height: 30px;" type="text" name="optionurl" value=" <s:property value='optionurl'/>" />
										<img style="cursor: pointer;" onclick="deleteoptions(<s:property value='optionid'/>)" title="删除选项" style="margin-left: 0px;margin-top: 4px;" width="20px;" height="20px;cursor: pointer;"
											src="<%=rootPath%>view/images/deleteicon.jpg" />
									</div>
								</s:iterator>
							</s:iterator>
						</div>
